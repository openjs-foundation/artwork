...
<table>
    ...
    <tr>
        ...
        <td><img src="./webhint-logo-stacked-color.png" width="95"></td>
        <td><img src="./webhint-icon-color.png" width="75"></td>
        <td><img src="../no_artwork_available.png" width="200"></td>
        <td><img src="./webhint-logo-stacked-color.svg" width="95"></td>
        <td><img src="./webhint-icon-color.svg" width="75"></td>
    </tr>  
</table>
